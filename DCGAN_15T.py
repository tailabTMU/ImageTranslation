...
def save_plot(examples, epoch, n=10):
  ...
  for i in range(n * n):
    ...
    # save plot to file
    filename = './figures/DCGAN/generated15T_plot_e%03d.png' % (epoch+1)
...
def summarize_performance(epoch, g_model, d_model, dataset, latent_dim, n_samples=100):
  ...
  filename = './models/DCGAN/generator15T_model_%03d.h5' % (epoch + 1)
...
# load model
model = load_model('./models/DCGAN/generator15T_model_050.h5')
# generate images
